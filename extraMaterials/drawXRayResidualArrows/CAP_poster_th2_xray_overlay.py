...
f = ROOT.TFile("QL2C04_2900V_xray_offset_error_120um_strip_position_analysis.root")
h = f.Get("xbin_width_100mm_ybin_width_100mm_means_layer2_fixedlayers14")
...
# Add the xray points
allData = pd.read_csv("QL2C04_2900V_xray_residuals.csv")
# Select only the layer 2, fixed layers 1 and 4 data
dataSubset = allData.loc[((allData['layer']==2) & (allData['fixed_layer_a']==1) & (allData['fixed_layer_b']==4)),['x', 'y', 'residual', 'residual error']]

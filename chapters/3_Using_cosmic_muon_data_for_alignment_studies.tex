...
%TODO : The x-ray area of interest is only about 20 mm, not 80 mm as previously thought (you were looking at plots without collimator). Gotta sort this out.
...
\end{subfigure}
\caption{Mean of residuals in each \SI{100}{\milli\meter} by \SI{100}{\milli\meter} bin over the area of the quad layer for QL2.P.11.}

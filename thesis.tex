...
\input{chapters/2_High_energy_particle_physics}
\input{chapters/3_The_LHC_and_ATLAS}
\input{chapters/4_The_new_small_wheel}
\input{chapters/5_Using_cosmic_muons_to_measure_relative_strip_position_offsets}
\input{chapters/6_Using_x-rays_to_measure_relative_strip_position_offsets}
\input{chapters/7_Comparing_cosmic_muon_and_x-ray_relative_strip_position_offsets}
\input{chapters/8_Summary_and_outlook}
...
\input{appendices/appendix-clustering.tex}
\input{appendices/appendix-statistics.tex}
\input{appendices/appendix-systematics.tex}
\input{appendices/appendix-print.tex}

...
%----------------------------------------------------------------------
\input{thesis-frontpgs} % Edit input .tex file to change title! - LF
...
\input{chapters/2_Characterization_of_sTGC_modules_using_cosmic_rays}
...
% \input{appendices/appendix-matlab_plots.tex}
\input{appendices/appendix_double_gaussian.tex}
\input{appendices/appendix-area_bin_size.tex}

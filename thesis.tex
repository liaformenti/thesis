...
\input{chapters/2_The_LHC_and_ATLAS}
\input{chapters/3_The_new_small_wheel}
\input{chapters/4_Using_cosmic_muons_to_measure_relative_strip_position_offsets}
\input{chapters/5_Using_x-rays_to_measure_relative_strip_position_offsets}
\input{chapters/6_Comparing_cosmic_muon_and_x-ray_relative_strip_position_offsets}
\input{chapters/7_Summary_and_outlook}

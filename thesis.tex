...
\input{chapters/2_Characterization_of_sTGCs_using_cosmic_rays}
\input{chapters/3_Using_cosmic_muon_data_for_alignment_studies}
\input{chapters/4_Validating_xray_offsets_with_cosmics_data}
\input{chapters/5_Summary_and_outlook}
